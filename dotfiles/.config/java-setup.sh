...
docker run --name mvn-with-user maven:3.3.3-jdk-8 /bin/bash -c "groupadd -f -g $(id -g) dummy && useradd -u $(id -u) -g dummy dummy && mkdir -p /home/dummy && chown -R dummy:dummy /home/dummy"
